      ...
      <section className="section-pad">
        <div className="container-wide">
          <div className="panel mb-8 grid gap-3 p-4 lg:grid-cols-[1fr_repeat(4,180px)_auto]">
            ...
            <select aria-label="Sport filter" className="rounded-md border border-slate-300 bg-white px-3 dark:border-white/10 dark:bg-[#151833]"><option>All Sports</option>{sports.map((sport) => <option key={sport.name}>{sport.name}</option>)}</select>
            <select aria-label="Age group filter" className="rounded-md border border-slate-300 bg-white px-3 dark:border-white/10 dark:bg-[#151833]"><option>Age Group</option><option>U-14</option><option>U-16</option><option>U-18</option></select>
            <select aria-label="Gender filter" className="rounded-md border border-slate-300 bg-white px-3 dark:border-white/10 dark:bg-[#151833]"><option>Gender</option><option>Female</option><option>Male</option></select>
            <select aria-label="Achievement level filter" className="rounded-md border border-slate-300 bg-white px-3 dark:border-white/10 dark:bg-[#151833]"><option>Achievement Level</option><option>District</option><option>State</option><option>National</option></select>
